...
The build script we'll be using is contained in the Nairacoin github repository ([contrib/gitian-build.py](https://github.com/forking-altcoins/nairacoin/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the Nairacoin repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/forking-altcoins/Nairacoin/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, nairacoin-detached-sigs, and nairacoin GitHub repos.
