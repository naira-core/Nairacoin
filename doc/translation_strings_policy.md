...
This document provides guidelines for internationalization of the Nairacoin Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to Nairacoin network</source>
        <translation>
            <numerusform>%n active connection to Nairacoin network</numerusform>
            <numerusform>%n active connections to Nairacoin network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `nairacoin_en.ts` remains unchanged.
