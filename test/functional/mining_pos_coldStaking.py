...
from test_framework.nairacoin_node import NairacoinTestNode
...
class Nairacoin_ColdStakingTest(NairacoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(NairacoinTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, None, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 NRC from the pot)
...
if __name__ == '__main__':
    Nairacoin_ColdStakingTest().main()
