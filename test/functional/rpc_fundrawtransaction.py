...
class RawTransactionsTest(NairacoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid nairacoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid nairacoin address" in e.error['message'])
