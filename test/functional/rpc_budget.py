...
class BudgetProposalTest(NairacoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid Nairacoin address")
        assert_raises_rpc_error(-5, "Invalid Nairacoin address", self.nodes[0].preparebudget,
