...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/nairacoin-cli.cpp \
           src/nairacoin-tx.cpp \
           src/nairacoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/nairacoin.qrc src/qt/nairacoin_locale.qrc

TRANSLATIONS += src/qt/locale/nairacoin_bg.ts \
                src/qt/locale/nairacoin_de.ts \
                src/qt/locale/nairacoin_en.ts \
                src/qt/locale/nairacoin_es.ts \
                src/qt/locale/nairacoin_fi.ts \
                src/qt/locale/nairacoin_fr.ts \
                src/qt/locale/nairacoin_it.ts \
                src/qt/locale/nairacoin_ja.ts \
                src/qt/locale/nairacoin_pl.ts \
                src/qt/locale/nairacoin_pt.ts \
                src/qt/locale/nairacoin_ru.ts \
                src/qt/locale/nairacoin_sk.ts \
                src/qt/locale/nairacoin_sv.ts \
                src/qt/locale/nairacoin_vi.ts \
                src/qt/locale/nairacoin_zh_CN.ts \
                src/qt/locale/nairacoin_zh_TW.ts
