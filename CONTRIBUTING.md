Contributing to Nairacoin Core
============================

The Nairacoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/forking-altcoins/nairacoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Nairacoin Core project, and is not to be
confused with overall Nairacoin Network Protocol consensus changes.

Whether a pull request is merged into Nairacoin Core rests with the project merge
...
Patches that change Nairacoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Nairacoin consensus, it must have been
...
The project leader is the release manager for each Nairacoin Core release.
