/* src/config/nairacoin-config.h.  Generated from nairacoin-config.h.in by configure.  */
/* src/config/nairacoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://github.com/forking-altcoins/nairacoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Nairacoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Nairacoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "nairacoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://nairacoin.org/"
