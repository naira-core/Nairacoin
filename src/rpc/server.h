...
/**
 * Nairacoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzNRCseed(const UniValue& params, bool fHelp);
extern UniValue getzNRCseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzNRC(const UniValue& params, bool fHelp);
extern UniValue dzNRCstate(const UniValue& params, bool fHelp);
