...
#ifndef Nairacoin_ZNRCTRACKER_H
#define Nairacoin_ZNRCTRACKER_H
...
public:
    CzNRCTracker(std::string strWalletFile);
    ~CzNRCTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzNRCWallet* zNRCWallet = NULL);
