// Copyright (c) 2017-2018 The Nairacoin developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef Nairacoin_ZNRCWALLET_H
#define Nairacoin_ZNRCWALLET_H
...
public:
    CzNRCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZNRC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZNRC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
