...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Nairacoin Core nairacoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nairacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nairacoin transaction") + "\n" +
                               "  nairacoin-tx [options] -create [commands]   " + _("Create hex-encoded nairacoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nairacoin transaction
