...
// Copyright (c) 2015-2019 The Nairacoin developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x000003773b413b74d9f903c9a45ba001aa1490d6bdc116734d21bad7c47be891"));  //launch
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1675149025, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("0485a8441924aab3cc019e6e1c2db6e8d2579c4f33a8ac8a411df60b13df1939b53d14187930d020b531d79f65358bea4eb129964c036dc3a16728297999778e58");
        nDefaultPort = 25333;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Nairacoin starting difficulty is 1 / 2^12
        ...
        nTargetTimespan = 10 * 60;                      // 40 minutes
        ...
        nLastPOWBlock = 200;
        nNairacoinBadBlockTime = 4070908800; // Skip nBit validation of Block 259201 per PR #915
        nNairacoinBadBlocknBits = 0x00; // Skip nBit validation of Block 259201 per PR #915
        ...
        nEnforceNewSporkKey = 1675149025; //!> Sporks signed after Monday, August 26, 2019 11:00:00 PM GMT must use the new spork key
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Tuesday, January 31, 2023 7:10:25 - start blockchain NRC.";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << std::vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04c841e835a9cc96a0a8fb73641fae2036aaf97b4539c93c4748281e79a2f4f88ce90a44da21df85edf924f36f4c674cc3c010ca930d2448225578b2777df23e26") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = BlockMerkleRoot(genesis);
        genesis.nVersion = 1;
        genesis.nTime = 1675149025;
        genesis.nBits = 0x1e0fffff;
        genesis.nNonce = 4068253;

	
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000003773b413b74d9f903c9a45ba001aa1490d6bdc116734d21bad7c47be891"));
        assert(genesis.hashMerkleRoot == uint256("0x8524b0844975f4dba88e6638add3bdcf4d2d4342c59f67df6dd356be85f11518"));

		vFixedSeeds.clear();
		vSeeds.clear();

        vSeeds.push_back(CDNSSeedData("213.252.247.244", "213.252.247.244"));
        vSeeds.push_back(CDNSSeedData("88.119.161.155", "88.119.161.155"));
        vSeeds.push_back(CDNSSeedData("185.25.50.104", "185.25.50.104"));
        ...
        strSporkPubKey = "04019450eaaf30b792b881607f41dd4e2f3516ea51bedd8be9cd0e67536cf76b8a5339656726f3aba258a7cc5dba126ba27c29257a6cb68cff9b0af42182c40e61";
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zNRC to be stakable
...
public:
    CTestNetParams()
    {
        ...
        vAlertPubKey = ParseHex("041408dc09f2b56fef1f31c68be802ab8a3dfde2f867788e797848f522aace8755bfaefa5f53b2399c976275b1c5b6dd19f73dd27d8e5b7d17ebb33ba8a1114973");
        nDefaultPort = 19340;
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 200;
        nNairacoinBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nNairacoinBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 48); // Testnet nairacoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 135);  // Testnet nairacoin script addresses start with 'w'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 125);     // starting with 's'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet nairacoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet nairacoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet nairacoin BIP44 coin type is '1' (All coin's testnet default)
        ...
        strSporkPubKey = "04be6e9cefc5990204bc1256bd937da4057821194ab07a8c5d03b566eb7432861e37c22f5fc63afcffd006b1080fb1a36a62c440ceacb9a201dd26348abe461184";
        ...
        strObfuscationPoolDummyAddress = "LW5mnPduovqtohyQXYmcVwA7LH2TRSaCh5";
        nStartMasternodePayments = 1675149025; //Fri, 09 Jan 2015 21:05:58 GMT
