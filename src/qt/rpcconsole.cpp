                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzNRCPathCustom = GetArg("-zNRCbackuppath", "");
    ...
    if(!strzNRCPathCustom.empty()) {
        ui->wallet_customzNRCbackuppath->setText(QString::fromStdString(strzNRCPathCustom));
        ui->wallet_customzNRCbackuppath_label->setVisible(true);
        ui->wallet_customzNRCbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzNRCPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Nairacoin RPC console.") + "<br>" +
