...
#include "qt/nairacoin/forms/ui_topbar.h"
#include <QPixmap>
#include "qt/nairacoin/lockunlock.h"
#include "qt/nairacoin/qtutils.h"
#include "qt/nairacoin/receivedialog.h"
...
TopBar::TopBar(NairacoinGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel(){
    ...
    // update the display unit, to not use the default ("Nairacoin")
    updateDisplayUnit();
