...
#include "qt/nairacoin/forms/ui_receivewidget.h"
...
#include "qt/nairacoin/addressholder.h"
...
ReceiveWidget::ReceiveWidget(NairacoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive NRC."));
