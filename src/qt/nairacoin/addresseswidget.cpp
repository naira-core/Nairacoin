...
#include "qt/nairacoin/forms/ui_addresseswidget.h"
#include "qt/nairacoin/addresslabelrow.h"
#include "qt/nairacoin/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(NairacoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::AddressesWidget)
{
    ...
    // Address
    ui->labelAddress->setText(tr("Enter Nairacoin address"));
