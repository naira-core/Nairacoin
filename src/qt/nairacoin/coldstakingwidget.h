...
#include "qt/nairacoin/sendmultirow.h"
#include "qt/nairacoin/coldstakingmodel.h"
#include "qt/nairacoin/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(NairacoinGUI* parent);
    ~ColdStakingWidget();
