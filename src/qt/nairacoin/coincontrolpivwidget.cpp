...
#include "qt/nairacoin/coincontrolpivwidget.h"
#include "qt/nairacoin/forms/ui_coincontrolpivwidget.h"
    ...
    ui(new Ui::CoinControlPivWidget)
{
    ...
    ui->labelTitle->setText("Select NRC Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("NRC");
    ...
    ui->labelValueAfter->setText("0.00 NRC");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 NRC");
    ui->labelValueFee->setText("0.00 NRC");
