...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, NairacoinGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, NairacoinGUI *gui, double posX = 3);
