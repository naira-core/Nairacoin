...
#include "qt/nairacoin/forms/ui_navmenuwidget.h"
...
NavMenuWidget::NavMenuWidget(NairacoinGUI *mainWindow, QWidget *parent) :
    ...
    ui(new Ui::NavMenuWidget)
{
    ...
    setCssProperty(ui->imgLogo, "img-nav-logo-nairacoin");
