...
#include "qt/nairacoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/nairacoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(NairacoinGUI* _window, QWidget *parent) :
