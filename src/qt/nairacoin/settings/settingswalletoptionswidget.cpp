...
#include "qt/nairacoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/nairacoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(NairacoinGUI* _window, QWidget *parent) :
