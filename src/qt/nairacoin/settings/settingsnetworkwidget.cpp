...
#include "qt/nairacoin/settings/settingsnetworkwidget.h"
#include "qt/nairacoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/nairacoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(NairacoinGUI* _window, QWidget *parent) :
