...
#include "qt/nairacoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/nairacoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(NairacoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to NairacoinGUI::handleRestart()
