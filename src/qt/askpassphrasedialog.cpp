...
#include "qt/nairacoin/loadingdialog.h"
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        bool ret = openStandardDialog(
                ...
                tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR NRC</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                tr("ENCRYPT"), tr("CANCEL")
        );
        if (ret) {
            if (newpass1 == newpass2) {
                newpassCache = newpass1;
                NairacoinGUI* window = static_cast<NairacoinGUI*>(parentWidget());
...
{
    NairacoinGUI* gui = static_cast<NairacoinGUI*>(parentWidget());
...
{
    hide();
    static_cast<NairacoinGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Nairacoin will close now to finish the encryption process. "
