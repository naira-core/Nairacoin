// Copyright (c) 2017-2020 The Nairacoin developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#include "zNRCcontroldialog.h"
#include "ui_zNRCcontroldialog.h"
    ...
    model(0)
{
    ...
    // Title
    ui->labelTitle->setText(tr("Select zNRC Denominations to Spend"));
    ...
    for (const CMintMeta& mint : setMints) {
        ...
        if(!fSpendable) {
            ...
            if(nConfirmations < Params().Zerocoin_MintRequiredConfirmations())
                ...
                strReason = "Your wallet is locked. Impossible to spend zNRC.";
            else if (!mint.isSeedCorrect)
                strReason = "The zNRC seed used to mint this zNRC is not the same as currently hold in the wallet";
            else
