...
/** Utility functions used by the Nairacoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Nairacoin addresses in monospace font
...
// Parse "nairacoin:" URI into recipient object, return true on successful parsing
