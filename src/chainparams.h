 ...
 * Nairacoin system. There are three: the main network on which people trade goods
...
public:
    ...
    int NairacoinBadBlockTime() const { return nNairacoinBadBlockTime; }
    int NairacoinBadBlocknBits() const { return nNairacoinBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nNairacoinBadBlockTime;
    unsigned int nNairacoinBadBlocknBits;
